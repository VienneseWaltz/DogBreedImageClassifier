...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            # If it doesn't exist within dognames_dic, add the dogname(line)
            # to dognames_dic
            if line not in dognames_dic:
                dognames_dic[line] = 1
            else:
                print("Warning: Duplicate {} exists in dognames.txt".format(line))
            
            # Reads in next line in file to be processed if this line isn't empty (EOF) 
            line = infile.readline() 
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            if results_dic[key][1] in dognames_dic:
                ...
                # indicates the pet label is-a-dog, classifier label is-NOT-a-dog
                results_dic[key].extend((1,0))
        # Pet Image Label IS NOT a Dog image (i.e. NOT found in dognames_dic)
        else:
            if results_dic[key][1] in dognames_dic:  
                # indicates the pet label is-NOT-a-dog, classifier label is-a-dog
                results_dic[key].extend((0,1))
            else:
                # indicates the pet label is-NOT-a-dog, classifier label is-NOT-a-dog
