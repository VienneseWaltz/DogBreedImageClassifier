...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # If pet image is a dog AND pet image label and classifier label is a MATCH (i.e.
        # idx 2 = 1), and idx 3 = idx 4 = 1
        if sum(results_dic[key][2:]) == 3:
            results_stats_dic['n_correct_breed'] += 1
        
        # If pet image (i.e. idx 3) is a dog 
        if results_dic[key][3] == 1: 
            results_stats_dic['n_dogs_img'] += 1
            
            # Classifier label classifies as dog (and pet image label is a dog)
            # counts the number of correct dogs classified
            if results_dic[key][4] == 1:
                results_stats_dic['n_correct_dogs'] += 1
        # Pet image(i.e. idx 3) is not a dog
        else:
            # Classifier (i.e. idx 4) classifies image as not a dog,  
            # counts the number of correct dogs classified
    ...
    # Calculates % correct not-a-dog images i.e. % of correctly classified as Not-a-dog
